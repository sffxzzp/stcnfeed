...
if (isset($_GET["tid"])) {
    $pageCont = curl('https://keylol.com/forum.php?mod=viewthread&tid='.$_GET["tid"]);
    ...
    echo '<html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"></head><body><a href="https://keylol.com/t'.$_GET["tid"].'-1-1">https://keylol.com/t'.$_GET["tid"].'-1-1</a><br>'.$postCont.'</body></html>';
}
?>